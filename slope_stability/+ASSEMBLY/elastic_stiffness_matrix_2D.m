...
%  stiffness matrix related to the elastoplastic body.
%
%  input data:
...
%    shear, bulk - elastic parameters at integration points
%
%  output data:
...
%
  ...
  % elastic tensor at each integration point: size(ELAST)=(9, n_int)
  iota  = [1;1;0] ;                      % unit second tensor
